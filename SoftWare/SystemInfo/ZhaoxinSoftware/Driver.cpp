...
#define WDF_SECTION_NAME L"SystemInfo.NT.Wdf"
...
)
{
	...
	if (FAILED(StringCchCat(DriverLocation, BufferLength, _T("\\") DRIVER_NAME))) {
		return FALSE;
	}
...
)
{
	...
	const TCHAR*  coinstallerVersion;
