...
typedef struct _DDR3_INFO
{
	union 
	{
		struct  
		{
			...
			BYTE ManufacturerSpecificData[26]; // Bytes 150 ~ 175: Manufacturer°Øs Specific Data
...
typedef struct _DDR4_INFO
{
	union
	{
		struct 
		{
			...
			BYTE ManufacturerSpecificData[29]; // Bytes 353~381 (0x161~0x17D): Manufacturerís Specific Data
