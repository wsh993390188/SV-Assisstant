...
void CPUHardwareWidget::Init()
{
	...
	if (Ring0::GetPCIVendorID() == 0x1022)
	{
		if (cache[0].Cache_Size > 1024)
			cpucacheL1D->cpuinfo->setText(tr("%1 MB %2-Ways").arg(QString::number(cache[0].Cache_Size / 1024 , 10)).arg(QString::number(cache[0].Cache_Ways)));
		else
			cpucacheL1D->cpuinfo->setText(tr("%1 KB %2-Ways").arg(QString::number(cache[0].Cache_Size , 10)).arg(QString::number(cache[0].Cache_Ways)));


		if (cache[1].Cache_Size > 1024)
			cpucacheL1T->cpuinfo->setText(tr("%1 MB %2-Ways").arg(QString::number(cache[1].Cache_Size / 1024 , 10)).arg(QString::number(cache[1].Cache_Ways)));
		else
			cpucacheL1T->cpuinfo->setText(tr("%1 KB %2-Ways").arg(QString::number(cache[1].Cache_Size , 10)).arg(QString::number(cache[1].Cache_Ways)));

		if (cache[2].Cache_Size > 1024)
			cpucacheL2->cpuinfo->setText(tr("%1 MB %2-Ways").arg(QString::number(cache[2].Cache_Size / 1024 , 10)).arg(QString::number(cache[2].Cache_Ways)));
		else
			cpucacheL2->cpuinfo->setText(tr("%1 KB %2-Ways").arg(QString::number(cache[2].Cache_Size , 10)).arg(QString::number(cache[2].Cache_Ways)));

		if (cache[3].Cache_Size > 0)
			if (cache[3].Cache_Size  > 1024)
				cpucacheL3->cpuinfo->setText(tr("%1 MB %2-Ways").arg(QString::number(cache[3].Cache_Size / 1024 , 10)).arg(QString::number(cache[3].Cache_Ways)));
			else
				cpucacheL3->cpuinfo->setText(tr("%1 KB %2-Ways").arg(QString::number(cache[3].Cache_Size, 10)).arg(QString::number(cache[3].Cache_Ways)));
	}
	else
	{
