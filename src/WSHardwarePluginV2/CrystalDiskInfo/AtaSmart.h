...
public:
	...
	std::string GetDiskStatus(DWORD statusCode);
	...
	std::vector<CString> m_IdeController;
	std::vector<CString> m_ScsiController;
	std::vector<CString> m_UsbController;
	CString m_ControllerMap;
	std::vector<CString> m_BlackIdeController;
	std::vector<CString> m_BlackScsiController;
	std::vector<CString> m_SiliconImageController;
	std::vector<CString> m_UASPController;
