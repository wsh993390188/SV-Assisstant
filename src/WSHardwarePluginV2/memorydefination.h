		...
		struct DDR3_INFO
		{
			union
			{
				struct
				{
					...
					BYTE sTRRDmin; // Byte 19: Minimum Row Active to Row Active Delay Time (tRRDmin) tRRDmin Result(ns) = tRRDmin(MTB units) * Timebase(ns)
					...
					BYTE sTFAWminLeast; // Byte 29: Minimum Four Activate Window Delay Time (tFAWmin), Least Significant Byte
					union
					{
						struct
						{
		...
		struct DDR4_INFO
		{
			union
			{
				struct
				{
					...
					BYTE sTFAWminLeast; // Byte 37 (0x025): Minimum Four Activate Window Delay Time (tFAWmin), Least Significant Byte
					BYTE sTRRD_Smin; // Byte 38 (0x026): Minimum Activate to Activate Delay Time (tRRD_Smin), different bank group
					BYTE sTRRD_Lmin; // Byte 39 (0x027): Minimum Activate to Activate Delay Time (tRRD_Lmin), same bank group
