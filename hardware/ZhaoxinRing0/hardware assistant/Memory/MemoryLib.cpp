...
namespace SV_ASSIST
{
	namespace Memory
	{
		...
		{
#ifdef ZX_OutputLog
	Logger::Instance()->OutputLogInfo(el::Level::Debug, "********** Memory Loading **********");
#endif
			...
			{
#ifdef ZX_OutputLog
	Logger::Instance()->OutputLogInfo(el::Level::Debug, "Get Memory Error By SMBUS");
#endif
				...
				{
#ifdef ZX_OutputLog
	Logger::Instance()->OutputLogInfo(el::Level::Debug, "Reset IvyBridge DIMMSMBUS");
#endif
					m_data = nullptr;
	...
	Logger::Instance()->OutputLogInfo(el::Level::Debug, "Reset IvyBridge DIMMSMBUS");
			...
			{
				Logger::Instance()->OutputLogInfo(el::Level::Debug, boost::str(boost::format("SMBUS Address: %X") % i.first);
				Logger::Instance()->OutputLogInfo(el::Level::Debug, boost::str(boost::format("Memory Device ID: %02X") % i.second.first);
				Logger::Instance()->OutputLogInfo(el::Level::Debug, boost::str(boost::format("Memory Type: %02X") % i.second.first);
			}
#endif
				this->GetSPDInfo();
			...
			{
				Logger::Instance()->OutputLogInfo(el::Level::Debug, "Get Memory Info Error, Unknown DIMM SMBUS");
			}
	Logger::Instance()->OutputLogInfo(el::Level::Debug, "********** End Memory Loading **********\n");
#endif
		}
