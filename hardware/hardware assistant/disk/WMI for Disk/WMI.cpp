...
CDISKWMI::~CDISKWMI(void)
{
    CoUninitialize();
}

HRESULT CDISKWMI::InitialCom()
{
    HRESULT hr = E_FAIL;
    do {
...
VOID CDISKWMI::SetNamespace(wstring wstrNamespace)
{
	m_wstrNamespace = wstrNamespace;
}

HRESULT CDISKWMI::SetComSecLevels()
{
...
HRESULT CDISKWMI::Connect2WMI( CComPtr<IWbemLocator> pLoc,CComPtr<IWbemServices>& pSvc )
{
    HRESULT hr = E_FAIL;
    do {
...
HRESULT CDISKWMI::SetProxySecLevels( CComPtr<IWbemServices> pSvc )
{
    HRESULT hr = E_FAIL;
    do {
