...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, ZhaoxinRing0DeviceAdd)
#pragma alloc_text (PAGE, ZhaoxinRing0EvtIoDeviceControl)
#pragma alloc_text (PAGE, ZhaoxinRing0EvtIoStop)
#endif


NTSTATUS ZhaoxinRing0DeviceAdd(
	IN WDFDRIVER Driver,
...
// 					ZhaoxinRing0EvtDeviceIoInCallerContext);
	...
	ioQueueConfig.EvtIoDeviceControl = ZhaoxinRing0EvtIoDeviceControl;
	ioQueueConfig.EvtIoStop = ZhaoxinRing0EvtIoStop;
...
VOID
ZhaoxinRing0EvtIoDeviceControl(
	_In_ WDFQUEUE Queue,
...
--*/
{
	...
	PAGED_CODE();
	//PVOID buffer = NULL;//DeviceIoControlµÄÊäÈëÊä³öbuffer
