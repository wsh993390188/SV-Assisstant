...
const PTCHAR BlueCrash = _T("System\\CurrentControlSet\\Control\\CrashControl");

const PTCHAR FireWallPath = _T("System\\CurrentControlSet\\Services\\SharedAccess\\Parameters\\FirewallPolicy\\StandardProfile");
/*************************************************
